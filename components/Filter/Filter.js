...
const Filter = () => {
    ...
    const setFilteredCountries = useCountriesState((state) => state.setFilteredCountries);
    ...
    return (
        <div className={theme === "light" ? styles.selectContainerLight : styles.selectContainerDark}>
            <select
                value={RegionValue}
